...
# Yes, both code blocks produce the same result. The first prints "all systems go" for everything True.
# The second reverses the lgoic in the if/else statement. Both produce the same results.
